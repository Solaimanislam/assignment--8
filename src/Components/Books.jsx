        ...
        <section className="py-6 sm:py-12  dark:bg-gray-100 text-gray-100 dark:text-gray-800">
            <div className="container p-6 mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    {/* <article className="flex flex-col p-2  rounded-lg border border-black">
                        <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum">
                            <img alt="" className="object-cover w-full h-full bg-gray-400  rounded-lg" src={books[0].image} />
                        </a>
                        <div className="flex flex-col flex-1 p-6">
                            <a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
                            <a rel="noopener noreferrer" href="#" className="text-xs tracking-wider uppercase hover:underline text-violet-400 dark:text-violet-600">{books[0].tags.map{}}</a>
                            <h3 className="flex-1 py-2 text-lg font-semibold text-black leading-snug">{books[0].bookName}</h3>
                            <p className=" text-black">By: {books[0].author} </p>
