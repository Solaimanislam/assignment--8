        ...
        <div className="card space-y-4 p-3 lg:card-side bg-base-100 border-2">
            ...
            <div className="card-body">
                ...
                <div className=" lg:flex items-center justify-between">
                    <button className="btn bg-[#328EFF26] mb-2 rounded-full px-4">Category: {category}</button>
                    <button className="btn bg-[#FFAC3326] mb-2 rounded-full px-6">Rating: {rating}</button>
